...
class ProductAPIView(APIView):
    ...
    def post(self, request):
        ...
        if not serializer.is_valid():
            ...
            return Response(
                {"errors": serializer.errors, "massage": "Somthing Went Worng"},
                status=status.HTTP_404_NOT_FOUND,
            )
        serializer.save()
        return Response(
            {"Playload": serializer.data, "massage": "Data has been saved"},
    ...
    def put(self, request, pk=None):
        try:
            ...
            serializer.save()
            return Response(
                {"Playload": serializer.data, "massage": "Data has been updated"},
                status=status.HTTP_202_ACCEPTED,
            )
        except Product.DoesNotExist:
            return Response(
                {"massage": "Data is DoesNotExist"}, status=status.HTTP_400_BAD_REQUEST
            )
    ...
    def patch(self, request, pk=None):
        try:
            ...
            serializer = ProductSerializer(
                product_objs, data=request.data, partial=True
            )
...
class CategoryAPIView(APIView):
    ...
    def patch(self, request, pk=None):
        try:
            ...
            serializer = CategorySerializer(
                category_objs, data=request.data, partial=True
            )
    ...
    def delete(self, request, pk=None):
        try:
            ...
            return Response(
                {"massage": "Data DoesNotExist"}, status=status.HTTP_400_BAD_REQUEST
            )
